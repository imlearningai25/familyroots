      ...
      <div className="w-full max-w-sm text-center">
        ...
        {state === 'confirming' && (
          <div className="bg-white rounded-2xl border border-slate-200 shadow-card p-8">
            ...
            <p className="text-sm text-slate-600">Confirming account deletion…</p>
          </div>
        )}
        ...
        {state === 'success' && (
          <div className="bg-white rounded-2xl border border-slate-200 shadow-card p-8">
            ...
            <h2 className="text-lg font-semibold text-slate-900 mb-2">Account deleted</h2>
            <p className="text-sm text-slate-500 mb-6">
              Your FamilyRoots account and all associated data have been permanently deleted.
        ...
        {state === 'error' && (
          <div className="bg-white rounded-2xl border border-slate-200 shadow-card p-8">
            ...
            <h2 className="text-lg font-semibold text-slate-900 mb-2">Deletion failed</h2>
        ...
        {state === 'missing' && (
          <div className="bg-white rounded-2xl border border-slate-200 shadow-card p-8">
            ...
            <p className="text-sm text-slate-500 mb-6">
              No deletion token found. Please use the link from your confirmation email.
            </p>
            <Link to="/" className="text-sm text-brand-600 hover:text-brand-700 font-medium">
              Back to home
            </Link>
